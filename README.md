...
<p align="center" >
    <img width="33%" height="33%" src="./__assets__/createAppointment.gif" alt="Create Appointment">
</p>

## List Appointments / Profile:

<img src="./__assets__/listAppointments.gif" alt="List Appointments / Profile">
